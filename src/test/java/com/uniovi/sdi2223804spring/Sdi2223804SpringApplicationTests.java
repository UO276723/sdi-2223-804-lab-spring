package com.uniovi.sdi2223804spring;

import com.uniovi.sdi2223804spring.pageobjects.*;
...
class Sdi2223804SpringApplicationTests {

    static String PathFirefox = "C:\\Program Files\\Mozilla Firefox\\firefox.exe";
    //static String Geckodriver = "C:\\Path\\geckodriver-v0.30.0-win64.exe";
    static String Geckodriver = "C:\\Users\\uo276723\\Desktop\\sesion06\\PL-SDI-Sesión5-material\\geckodriver-v0.30.0-win64.exe";
...
// Propiedad: Error.signup.dni.length
    ...
    public void PR10() {
        ...
        PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
        //Rellenamos el formulario
        PO_LoginView.fillLoginForm(driver, "19999990A", "123456");
        //Comprobamos que vuelve a la misma pagina
...
//P14. Esta prueba podría encapsularse mejor ...
    ...
    public void PR15() {
        ...
        //Esperamos a que se muestren los enlaces de paginación la lista de nota
        //Nos vamos a la última página
        PO_PrivateView.clickOnElement(driver, "//a[contains(@class, 'page-link')]", 3);
